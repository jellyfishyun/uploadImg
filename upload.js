    ...
    $(function() {
        ...
        function addFile( file ) {
            ...
            $li.on( 'mouseenter', function() {
                ...
                $(this).find('.set-cover').stop().animate({height: 26});
            });

            $li.on( 'mouseleave', function() {
                if($(this).index() == 0) return
                $(this).find('.set-cover').stop().animate({height: 0});
            });
            ...
            $btns.on( 'click', 'span', function() {
                ...
                switch ( index ) {
                    case 0:
                        ...
                        return;
                    case 1:
                        $li.find('.set-cover').stop().animate({height: 0}, 0);
                        $queue.prepend($li)
                        return;
                }
            });
